defmodule StatesLanguage.TestClient do
  @external_resource "test/support/states_language_test1.json"

  use StatesLanguage, data: "test/support/states_language_test1.json"
